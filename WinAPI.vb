...
#Disable Warning CA1401
    ...
    End Function
    <DllImport("user32.dll", CharSet:=CharSet.Unicode, SetLastError:=True)>
    Public Shared Function GetClipboardFormatName(format As UInteger, lpszFormatName As System.Text.StringBuilder, cchMaxCount As Integer) As Integer
    End Function
    <DllImport("user32.dll", CharSet:=CharSet.Unicode, SetLastError:=True)>
    ...
    Public Shared Function WlanOpenHandle(ByVal dwClientVersion As UInteger, ByVal pReserved As IntPtr, ByRef pdwNegotiatedVersion As UInteger, ByRef phClientHandle As IntPtr) As Integer
    End Function
    <DllImport("wlanapi.dll")>
    Public Shared Function WlanEnumInterfaces(ByVal hClientHandle As IntPtr, ByVal pReserved As IntPtr, ByRef ppInterfaceList As IntPtr) As Integer
    End Function
    <DllImport("wlanapi.dll")>
    Public Shared Function WlanQueryInterface(ByVal hClientHandle As IntPtr, ByVal pInterfaceGuid As Guid, ByVal OpCode As WLAN_INTF_OPCODE, ByVal pReserved As IntPtr, ByRef pdwDataSize As UInteger, ByRef ppData As IntPtr, ByVal pWlanOpcodeValueType As UInteger) As Integer
    End Function
    <DllImport("wlanapi.dll")>
    Public Shared Sub WlanFreeMemory(ByVal pMemory As IntPtr)
    End Sub
    <DllImport("wlanapi.dll")>
    Public Shared Function WlanCloseHandle(ByVal hClientHandle As IntPtr, ByVal pReserved As IntPtr) As Integer
    End Function
